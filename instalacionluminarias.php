...
<head>
    <meta charset="UTF-8">
    <title>Instalación de Luminarias Solares - SDRIMSAC</title>
    <link rel="stylesheet" href="assets/css/estilo.css">
    <link rel="stylesheet" href="assets/css/instalacionluminarias/instalacionluminarias.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
</head>
<body>
<?php include("includes/header.php"); ?>
<section class="instalacionluminarias-banner">
    <div class="banner-bg"></div>
    <div class="banner-content">
        <h1>Instalación de Luminarias Solares</h1>
        <div class="sub">Sdrim S.A.C.</div>
        <div class="desc">Servicios : Instalación de Luminarias Solares</div>
        <div class="frase-portada">Soluciones sostenibles y eficientes para tu empresa</div>
    </div>
</section>
...
<div class="luminarias-container">
    ...
    <div class="luminarias-beneficios-grid">
        <div class="luminarias-beneficio-card">
    ...
    <!-- Galería de imágenes -->
    <div class="luminarias-galeria">
        <img src="img/ilu1.jpg" alt="Luminaria solar 1">
        <img src="img/ilu2.jpg" alt="Luminaria solar 2">
        <img src="img/ilu3.jpg" alt="Luminaria solar 3">
        <img src="img/ilu4.jpg" alt="Luminaria solar 4">
        <img src="img/ilu5.jpg" alt="Luminaria solar 5">
        <img src="img/ilu6.jpg" alt="Luminaria solar 6">
    </div>
</div>
...
<section class="luminarias-faq-section">
    ...
    <div class="luminarias-faq-content">
        ...
        <div class="luminarias-faq-img">
            <img src="img/ilu1.jpg" alt="Panel solar y luminaria solar">
        </div>
    </div>
</section>

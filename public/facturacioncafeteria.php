...
<div class="cafeteria-desarrollo">
    <h2>DESARROLLO DE FACTURACIÓN ELECTRÓNICA</h2>
    <p>
        El servicio de desarrollo de facturación electrónica para un NEGOCIO – CAFETERÍA es una solución tecnológica diseñada para permitir que el negocio de cafetería emita facturas electrónicas de manera eficiente y cumpla con las regulaciones fiscales y legales vigentes en su país.<br>
...
<div class="cafeteria-faq-section">
    <div class="cafeteria-faq">
        ...
        <div class="cafeteria-faq-item active">
            <div class="cafeteria-faq-question">¿Qué es la facturación electrónica y por qué es obligatoria en mi cafetería?<span class="cafeteria-faq-toggle">&#9654;</span></div>
        ...
        <div class="cafeteria-faq-item">
            <div class="cafeteria-faq-question">¿Qué tipo de facturas debo emitir en mi cafetería?<span class="cafeteria-faq-toggle">&#9654;</span></div>
            <div class="cafeteria-faq-answer">
                Debes emitir facturas electrónicas y boletas de venta según el tipo de cliente y la normativa vigente.
            </div>
        </div>
        <div class="cafeteria-faq-item">
            <div class="cafeteria-faq-question">¿Qué información debe incluir la factura electrónica?<span class="cafeteria-faq-toggle">&#9654;</span></div>
            <div class="cafeteria-faq-answer">
                Debe incluir datos del emisor, receptor, detalle de productos o servicios, montos, impuestos y fecha de emisión.
            </div>
        </div>
        <div class="cafeteria-faq-item">
            <div class="cafeteria-faq-question">¿Cómo puedo almacenar y conservar las facturas electrónicas?<span class="cafeteria-faq-toggle">&#9654;</span></div>
            <div class="cafeteria-faq-answer">
                Puedes almacenarlas digitalmente en tu sistema o en la nube, asegurando copias de respaldo y acceso seguro.
            </div>
        </div>
        <div class="cafeteria-faq-item">
            <div class="cafeteria-faq-question">¿Qué sucede si no emito facturas electrónicas en mi cafetería?<span class="cafeteria-faq-toggle">&#9654;</span></div>
            <div class="cafeteria-faq-answer">

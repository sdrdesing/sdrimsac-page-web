<?php
// Plantilla básica para Facturación Créditos
?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    <title>Facturación Créditos - SDRIMSAC</title>
...
<body>
    ...
    <div class="page-banner">
        ...
        <div class="page-banner-overlay">
            <h1>Aplicativo para Facturacion Electronica- Creditos</h1>
    ...
    <div style="max-width:900px;margin:40px auto 0 auto;padding:0;background:#fff;border-radius:18px;box-shadow:0 2px 12px rgba(0,0,0,0.08);">
        <img src="assets/img/creditos.jpeg" alt="Facturación Electrónica Créditos" style="width:100%;border-radius:18px 18px 0 0;">
    </div>
    <!-- Desarrollo de Facturación Electrónica -->
    <div class="creditos-desarrollo">
...
<head>
<meta charset="UTF-8">
<title>Aplicativo para Facturación Electronica - Créditos - SDRIMSAC</title>
<link rel="stylesheet" href="assets/css/estilo.css">
<link rel="stylesheet" href="assets/css/facturacioncreditos.css">
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
